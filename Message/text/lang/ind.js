...
exports.wait = () => {
    return `Mohon tunggu sebentar ngab~`
}
...
exports.aktifan = () => {
    return `Tambahkan parameter *On* untuk mengaktifkan dan *Off* untuk menonaktifkan!`
}

exports.onsystem = (fcom) => {
    return `Berhasil mengaktifkan fitur ${fcom} pada group ini!`
}

exports.offsystem = (fcom) => {
    return `Berhasil menonaktifkan fitur ${fcom} pada group ini!`
}
